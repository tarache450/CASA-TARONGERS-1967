...
export interface TranslationDict {
  ...
  // Family Portal (Owner Dashboard)
  dashTitle: string;
  dashSubtitle: string;
  dashPinTitle: string;
  dashPinDesc: string;
  dashPinLabel: string;
  dashPinPlaceholder: string;
  dashPinError: string;
  dashPinBtn: string;
  dashPinHint: string;
  dashTabOverview: string;
  dashTabBookings: string;
  dashTabPayments: string;
  dashTabSettings: string;
...
export const TRANSLATIONS: Record<Language, TranslationDict> = {
  es: {
    ...
    // Info Tarifas
    tarifasTitle: 'INFO TARIFAS',
    tarifa1Title: 'TARIFA 1:',
    tarifa1Item1: '1 noche (casa compartida) - 20€',
    tarifa2Title: 'TARIFA 2:',
    tarifa2Item1: '1 noche (reserva toda la casa) - 100€',
    tarifa2Item2: '1 semana (reserva toda la casa) - 500€',
    limpiezaNote: 'LIMPIEZA: +50€ en todos los casos',

    // Family Portal (Owner Dashboard)
    dashTitle: 'Panel Casa Tarongers',
    dashSubtitle: 'Gestión familiar interna y finanzas en tiempo real.',
    dashPinTitle: 'Acceso de Propietarios',
    dashPinDesc: 'Área privada para que la familia administre el calendario, gestione el dinero y lleve el orden de Casa Tarongers.',
    dashPinLabel: 'Código PIN Familiar',
    dashPinPlaceholder: 'Escribe el PIN de 4 dígitos',
    dashPinError: 'Código PIN familiar incorrecto. Pista: Es el año de la casa.',
    dashPinBtn: 'Acceder al Panel',
    dashPinHint: 'Pista: Es el año del nombre de la casa (4 dígitos)',
    dashTabOverview: 'Estadísticas & Gráficos',
    dashTabBookings: 'Reservas & Bloqueos',
    dashTabPayments: 'Libro de Pagos',
  ...
  ca: {
    ...
    // Info Tarifas
    tarifasTitle: 'INFO TARIFES',
    tarifa1Title: 'TARIFA 1:',
    tarifa1Item1: '1 nit (casa compartida) - 20€',
    tarifa2Title: 'TARIFA 2:',
    tarifa2Item1: '1 nit (reserva tota la casa) - 100€',
    tarifa2Item2: '1 setmana (reserva tota la casa) - 500€',
    limpiezaNote: 'NETEJA: +50€ en tots els casos',

    // Family Portal (Owner Dashboard)
    dashTitle: 'Tauler Casa Tarongers',
    dashSubtitle: 'Gestió familiar interna i finances en temps real.',
    dashPinTitle: 'Accés de Propietaris',
    dashPinDesc: 'Àrea privada perquè la família administri el calendari, gestioni els diners i mantingui l\'ordre de Casa Tarongers.',
    dashPinLabel: 'Codi PIN Familiar',
    dashPinPlaceholder: 'Escriu el PIN de 4 dígits',
    dashPinError: 'Codi PIN familiar incorrecte. Pista: És l\'any de la casa.',
    dashPinBtn: 'Accedir al Tauler',
    dashPinHint: 'Pista: És l\'any del nom de la casa (4 dígits)',
    dashTabOverview: 'Estadístiques i Gràfics',
    dashTabBookings: 'Reserves i Bloquejos',
    dashTabPayments: 'Llibre de Pagaments',
  ...
  en: {
    ...
    // Info Tarifas
    tarifasTitle: 'RATES INFO',
    tarifa1Title: 'RATE 1:',
    tarifa1Item1: '1 night (shared house) - 20€',
    tarifa2Title: 'RATE 2:',
    tarifa2Item1: '1 night (entire house booking) - 100€',
    tarifa2Item2: '1 week (entire house booking) - 500€',
    limpiezaNote: 'CLEANING: +50€ in all cases',

    // Family Portal (Owner Dashboard)
    dashTitle: 'Casa Tarongers Portal',
    dashSubtitle: 'Internal family management and real-time finances.',
    dashPinTitle: 'Owners Access',
    dashPinDesc: 'Private area for the family to manage calendar, payments, and house organization.',
    dashPinLabel: 'Family PIN Code',
    dashPinPlaceholder: 'Enter 4-digit PIN',
    dashPinError: 'Incorrect family PIN code. Hint: House year.',
    dashPinBtn: 'Access Portal',
    dashPinHint: 'Hint: House name year (4 digits)',
    dashTabOverview: 'Stats & Charts',
    dashTabBookings: 'Bookings & Blocks',
    dashTabPayments: 'Payment Log',
