...
export const RECOMMENDATIONS: Recommendation[] = [
  ...
  {
    id: 'fronton-tournament',
    title: {
      ca: 'Torneig de Frontenis',
      es: 'Torneo de Frontón',
      en: 'Fronton Tournament'
    },
    subtitle: {
      ca: 'Campionat local de frontenis d\'Els Tarongers',
      es: 'Campeonato local de frontenis de Els Tarongers',
      en: 'Local fronton tournament of Els Tarongers'
    },
    distance: {
      ca: 'A la mateixa finca / 2 min',
      es: 'En la misma finca / 2 min',
      en: 'On site / 2 min'
    },
    duration: {
      ca: 'Segons partits',
      es: 'Según partidos',
      en: 'According to match schedule'
    },
    bestTime: {
      ca: 'Caps de setmana i jornada de torneig',
      es: 'Fines de semana y jornada de torneo',
      en: 'Weekends & match days'
    },
    category: {
      ca: 'Esport i Comunitat',
    ...
    description: {
      ...
      es: 'Gran campeonato local de frontenis relacionado con la zona de Els Tarongers. Un evento deportivo y comunitario único para disfrutar de la pasión por el frontón.',
      en: 'Great local fronton tournament related to the Els Tarongers area. A unique sports and community event to enjoy the passion for fronton.'
    },
    extraInfo: {
      ca: 'Accedeix a la web oficial del campionat per consultar els quadres de partits, horaris, resultats en directe i la classificació del torneig.',
      es: 'Accede a la web oficial del campeonato para consultar los cuadros de partidos, horarios, resultados en directo y la clasificación del torneo.',
      en: 'Access the official tournament website to check match brackets, schedules, live scores, and overall standings.'
    },
    tips: {
      ca: [
        'Consulta les rondes i horaris directament a la web del torneig.',
        'Es pot accedir a la pista fàcilment des de la casa.'
      ],
      es: [
        'Consulta las rondas y horarios directamente en la web del torneo.',
        'Se puede acceder a la pista fácilmente desde la casa.'
      ],
      en: [
        'Check match brackets and times directly on the tournament web page.',
        'Easy access to the court right from the house.'
      ]
    }
  }
];
