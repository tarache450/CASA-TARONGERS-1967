...
export default function BookingCalendar({ bookings, settings, onAddBooking, language }: BookingCalendarProps) {
  ...
  // Helper: Get first day of month starting on Monday (0 = Monday, 6 = Sunday)
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <div className="lg:col-span-7 bg-white p-6 md:p-8 border border-[#E5E1D8] shadow-sm">
            ...
            <div className="grid grid-cols-7 gap-1 text-center mb-2">
              {(language === 'ca' ? ['Dil', 'Dim', 'Dme', 'Dju', 'Div', 'Dis', 'Diu'] : language === 'en' ? ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'] : ['Lun', 'Mar', 'Mié', 'Jue', 'Vie', 'Sáb', 'Dom']).map(day => (
            ...
            {/* INFO TARIFAS Block */}
            <div id="info-tarifas" className="mt-6 bg-white p-6 md:p-8 border border-[#E5E1D8] shadow-sm">
              <div className="flex items-center gap-2 mb-5 pb-3 border-b border-[#E5E1D8]">
                <Tag className="w-4 h-4 text-accent-terracotta" />
                <h4 className="text-base font-serif italic font-medium tracking-wide text-stone-900 uppercase">
                  {t.tarifasTitle}
                </h4>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* TARIFA 1 */}
                <div className="bg-[#FAFAF5] p-4 border border-[#E5E1D8]">
                  <span className="text-[11px] font-sans font-bold uppercase tracking-wider text-stone-800 block mb-2">
                    {t.tarifa1Title}
                  </span>
                ...
                <div className="bg-[#FAFAF5] p-4 border border-[#E5E1D8]">
                  ...
                  <ul className="text-xs text-stone-600 font-sans font-light space-y-1">
              ...
              {/* LIMPIEZA */}
              <div className="mt-4 pt-3.5 border-t border-dashed border-[#E5E1D8] text-center">
                <span className="text-xs font-mono font-bold text-accent-terracotta tracking-wide uppercase">
                  {t.limpiezaNote}
                </span>
              </div>
            </div>
